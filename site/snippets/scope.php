<div class="one-col float scope last-child">
  <h2>scope</h2>
  <ul class="scope">
    <li <?php if(strpos($page->scope, 'research') !== false): ?>class="scope-on" <?php endif ?> ><a href="/scope/research">research</a></li>
    <li <?php if(strpos($page->scope, 'marketing') !== false): ?>class="scope-on"<?php endif ?> ><a href="/scope/marketing-strategy">marketing strategy</a></li>
    <li <?php if(strpos($page->scope, 'copy') !== false): ?>class="scope-on"<?php endif ?> ><a href="/scope/copywriting">copywriting</a></li>
    <li <?php if(strpos($page->scope, 'brand') !== false): ?>class="scope-on"<?php endif ?> ><a href="/scope/brand-positioning">brand positioning</a></li>
    <li <?php if(strpos($page->scope, 'naming') !== false): ?>class="scope-on"<?php endif ?> ><a href="/scope/naming">naming</a></li>
